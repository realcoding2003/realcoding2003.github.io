...
[MSA設計にChatGPTを活用した話](/ja/2024/02/10/msa-and-chatgpt-ja/)を書いたことがありますが、AIを業務で使えば使うほど、自然とベクトルデータベースへの関心が湧いてきました。
...
[クラウド vs オンプレミス](/ja/2020/04/20/cloud-vs-onpremise-server-ja/)の時もそうでしたし、[MySQL UUID活用](/ja/2020/04/21/mysql-uuid-usage-ja/)の時もそうでした。新しい技術が出てくると「これを使うべきか？」という悩みが生まれますが、答えはいつも「状況による」です。
