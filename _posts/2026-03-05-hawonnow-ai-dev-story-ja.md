...
![HawonNow NOWページ](/assets/images/posts/hawonnow-dev-story/01-now.png)
...
![週間スケジュール](/assets/images/posts/hawonnow-dev-story/02-schedule.png)
...
![塾管理と統計](/assets/images/posts/hawonnow-dev-story/03-academies.png)

**塾管理** — 塾名、先生の連絡先、送迎ドライバーの連絡先、月謝、支払日まで一箇所で管理。「今月の塾代いくら？」にアプリ一つで答えられます。

![統計画面](/assets/images/posts/hawonnow-dev-story/04-statistics.png)
