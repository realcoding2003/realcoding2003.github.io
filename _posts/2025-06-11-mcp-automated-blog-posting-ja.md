...
redirect_from:
  ...
  - /ja/2025/06/09/mcp-automated-blog-posting-ja/
  - /ja/2025/06/11/mcp-automated-blog-posting-ja/
  - /2025/06/11/mcp-automated-blog-posting-ja/
  - /ja/2025/06/09/mcp-automated-blog-posting/
  - /en/2025/06/09/mcp-automated-blog-posting-ja/
...
2. [AIでGitHub Pages技術ブログを作る (2) - MCPでSEO最適化された技術投稿完全自動化](/ja/2025/06/11/mcp-automated-blog-posting/) ← 現在の記事
...
**シリーズ前の記事**: [AIでGitHub Pages技術ブログを作る (1) - Claude Desktop MCPでローカルに直接Jekyllブログを生成](/ja/2025/06/08/claude-desktop-mcp-blog-setup/)

**シリーズ次の記事**: [AIでGitHub Pages技術ブログを作る (3) - MCPでGiscusコメントシステムを5分で完成](/ja/2025/06/13/mcp-giscus-comments-setup/)
