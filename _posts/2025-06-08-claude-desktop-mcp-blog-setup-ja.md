...
redirect_from:
  ...
  - /ja/2025/06/08/claude-desktop-mcp-blog-setup-ja/
  - /2025/06/08/claude-desktop-mcp-blog-setup-ja/
  - /ja/2025/06/09/claude-desktop-mcp-blog-setup/
...
**📚 シリーズ全体リスト**:
1. [AIでGitHub Pages技術ブログを作る (1) - Claude Desktop MCPでローカルに直接Jekyllブログを生成](/ja/2025/06/08/claude-desktop-mcp-blog-setup/) ← 現在の記事
...
**シリーズ次の記事**: [AIでGitHub Pages技術ブログを作る (2) - MCPでSEO最適化された技術投稿完全自動化](/ja/2025/06/11/mcp-automated-blog-posting/)
