...
redirect_from:
  ...
  - /ja/2021/03/15/aws-api-gateway-lambda-stages-ja/
...
[AWSにハマって勉強し](/ja/2020/09/10/getting-into-aws/)、[資格まで取った](/ja/2020/12/15/aws-developer-certification/)後、実際のプロジェクトに本格的に適用し始めました。
