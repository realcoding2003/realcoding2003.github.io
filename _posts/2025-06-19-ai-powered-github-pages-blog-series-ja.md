...
redirect_from:
  ...
  - /ja/2025/06/19/ai-powered-github-pages-blog-series-ja/
  - /2025/06/19/ai-powered-github-pages-blog-series-ja/
...
### [1編: Claude Desktop MCPでローカルに直接Jekyllブログを生成](/ja/2025/06/08/claude-desktop-mcp-blog-setup/)
...
### [2編: MCPでSEO最適化された技術投稿完全自動化](/ja/2025/06/11/mcp-automated-blog-posting/)
...
### [3編: MCPでGiscusコメントシステムを5分で完成](/ja/2025/06/13/mcp-giscus-comments-setup/)
...
### [4編: MCPでダーク/ライトモード完璧実装](/ja/2025/06/15/mcp-dark-light-mode-implementation/)
...
### [5編: MCPでJekyll多言語ブログ完成](/ja/2025/06/17/mcp-jekyll-multilingual-blog/)
...
準備ができたら[1編: Claude Desktop MCPでローカルに直接Jekyllブログを生成](/ja/2025/06/08/claude-desktop-mcp-blog-setup/)から始めてください！
...
3. [AIでGitHub Pages技術ブログを作る (3) - MCPでGiscusコメントシステムを5分で完成](/ja/2025/06/13/mcp-giscus-comments-setup/)
...
**シリーズ次の記事**: [AIでGitHub Pages技術ブログを作る (1) - Claude Desktop MCPでローカルに直接Jekyllブログを生成](/ja/2025/06/08/claude-desktop-mcp-blog-setup/)
